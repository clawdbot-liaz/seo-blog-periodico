        ...
        <div className="grid md:grid-cols-3 gap-8">
          {esportsPosts.length > 0 ? (
            ...
            <div className="col-span-3 bg-gray-50 rounded-2xl p-12 text-center border border-gray-200">
              ...
              <h3 className="text-xl font-bold text-gray-700 mb-3">No hay noticias de esports</h3>
              <p className="text-gray-500 max-w-md mx-auto">
                No hay noticias publicadas en esta categoría. Las noticias de esports aparecerán aquí cuando se publiquen.
              </p>
            </div>
          )}
        </div>
